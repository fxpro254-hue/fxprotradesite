...
define(['./workbox-d3667991'], (function (workbox) { 'use strict';

            self.skipWaiting();
            workbox.clientsClaim();
            workbox.registerRoute(/public\/images\/(?!.*favicons).*$/, new workbox.CacheFirst({
              "cacheName": "assets",
            ...
            workbox.registerRoute(/(trader|reports)\//, new workbox.CacheFirst({
