...
const RunPanel = observer(() => {
    ...
    const { BOT_BUILDER, CHART, AUTO, ANALYSIS_TOOL, TRADING_HUB, DTRADER } = DBOT_TABS;
    ...
    const show_run_panel =
        [BOT_BUILDER, CHART, AUTO, ANALYSIS_TOOL, TRADING_HUB].includes(active_tab) || active_tour;
