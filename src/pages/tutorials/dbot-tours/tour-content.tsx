...
export const DBOT_ONBOARDING = [
    {
        ...
        content: (
            <TourSteps
                label={<Localize i18n_default_text='Get started on FxProTrades' />}
                content={[
                    <>
...
export const DBOT_ONBOARDING_MOBILE: TMobileTourConfig[] = [
    {
        header: <Localize i18n_default_text='Get started on FxProTrades' />,
        content: [
...
export const onboarding_tour_header = (
    <Localize key='onboarding-tour-header' i18n_default_text='Get started on FxProTrades' />
);
