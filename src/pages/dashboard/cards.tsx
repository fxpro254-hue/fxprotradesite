...
const FreeBotsIcon = ({ height = '48px', width = '48px' }) => (
    <svg width={width} height={height} viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path
            d='M12 2C13.1046 2 14 2.89543 14 4V6H18C19.1046 6 20 6.89543 20 8V18C20 19.1046 19.1046 20 18 20H6C4.89543 20 4 19.1046 4 18V8C4 6.89543 4.89543 6 6 6H10V4C10 2.89543 10.8954 2 12 2Z'
...
const Cards = observer(({ is_mobile, has_dashboard_strategies }: TCardProps) => {
    ...
    const actions: TCardArray[] = [
        ...
        },
        {
            id: 'quick-strategy',
            icon: (
                <DerivLightQuickStrategyIcon height={is_mobile ? '32px' : '48px'} width={is_mobile ? '32px' : '48px'} />
            ),
